...
public class StompChatController {
    ...
    public void enterStudyRoom(ChatMessageDTO message) { // 1. DTO로 채팅 정보들을 다 받아온다.
        // 2. 1에서 받아온 DTO 값중 작성자를 가져와 참여메세지를 작성해 DTO 값중 메세지에 저장한다.
        message.setMessage(message.getWriter() + "님이 채팅방에 참여하였습니다.");
        // 3. 1에서 받아온 DTO 값중 작성자를 가져와 참여자로 저장한다.
    ...
    public void exitStudyRoom(ChatMessageDTO message) { // 1. DTO로 채팅 정보들을 다 받아온다.
        ...
        // 3. 1에서 받아온 DTO 값중 작성자를 가져와 퇴장자로 저장한다.
        message.setExit(message.getWriter());
        // 4. 1에서 받아온 DTO 값중 참가중인 인원을 가져와 1을 감소한뒤 다시 참가중인 인원에 저장한다.
